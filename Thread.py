...
class MyWin(QWidget):
    ...
    def init_ui(self):
        self.ui = uic.loadUi((r"E:\py\Pyqt5\QT Ddesigner\test1.ui"))

        # 从ui文件中加载控件
        lineedit = self.ui.lineEdit
        btn_1 = self.ui.pushButton
        btn_2 = self.ui.pushButton_2

        # 给2个按钮绑定槽函数
        btn_1.clicked.connect(self.click_1)  # 绑定槽函数
        btn_2.clicked.connect(self.click_2)  # 绑定槽函数
